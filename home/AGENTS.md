...
My main coding sessions are done using remote development on my lima Ubuntu VM
running on my macbook pro. I ssh to the laptop using tailscale and have the
laptop set to not sleep using the amphetamine app.
